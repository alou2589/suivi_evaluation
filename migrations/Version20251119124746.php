 ...
 */
final class Version20251119124746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matos_informatique ADD marque_matos_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matos_informatique DROP marque_matos_id');
    }
}
