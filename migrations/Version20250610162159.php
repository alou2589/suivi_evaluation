 ...
 */
final class Version20250610162159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE agent ADD CONSTRAINT FK_268B9C9DBC472C34 FOREIGN KEY (service_affecte_id) REFERENCES service (id)
        SQL);
        $this->addSql(<<<'SQL'
